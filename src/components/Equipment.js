...
render() {
    ...
    <h3>Belay Device</h3>
    <img class="alignright" src="img/belay.jpg" alt="An ATC-style belay device" />
    ...
    <img class="alignright" src="img/carabiner.jpg" alt="A chalk bag and a carabiner" />
